...
public static class CacheKeys
{
    ...
    public const string IDEMPOTENCY_PREFIX = "idempotency:";
    ...
    public static string GetIdempotencyKey(string userId, string idempotencyKey) => $"{IDEMPOTENCY_PREFIX}{userId}:{idempotencyKey}";
}